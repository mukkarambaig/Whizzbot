...
def reload_knowledge_base():
    ...
    create_knowedge_base()
    load_knowledge_base()


def initialize_llm_chain():
    """Initialize and return a RAG chain with the specified components."""
    retriever = vectorstore_manager.get_vectorstore_retriever(
        st.session_state['docsearch'])
    st.session_state['chain'] = bedrock_manager.initialize_rag_chain(
        retriever, prompt, bedrock_manager.bedrock_instance)
