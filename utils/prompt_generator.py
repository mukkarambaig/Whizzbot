...
examples = [{
    ...
    "Assistant": "Employees receive overtime pay at 1.5 times the regular rate after 40 hours of work in a week."
}, {
    "Human":
    ...
    "Assistant": "I apologize, but the provided document does not contain information on remote work from another country. Please provide a relevant document or Document."
}, {
    "Human":
...
def prompt_generator(
    ...
    prompt_template = PromptTemplate(
        input_variables=["Human", "Document", "nAssistant"],
    ...
    dynamic_prompt = FewShotPromptTemplate(
        ...
        prefix=
        """Instructions: You are an advanced AI assistant designed to function as an HR manager, with complete knowledge of a specific provided document. Your task is to provide clear and understandable answers to queries based on this document's content. Adhere to these guidelines when responding:

         - Rely STRICTLY solely on the information from the provided documents to answer questions. If the document does not contain the necessary information, apologize and clarify that the relevant context is missing.
...
def main():
    ...
    print(prompt_generator(prompt, context))
